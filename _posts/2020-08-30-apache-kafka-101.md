...
---
I recently started learning about Apache Kafka. Apache Kafka was first created by LinkedIn and is now an open source project mainly maintained by Confluent. I strongly recommend Stéphane Maarek's course, "Apache Kafka Series - Learn Apache Kafka for Beginners". This article is essentially a summary of what I learned taking that course. I wrote this for other beginners to get an introduction into Kafka, learn about the motivations behind it, some of the concepts like brokers, topics, and partitions, as well as try a little hands-on. I've always found doing to be the most effective way of learning.
